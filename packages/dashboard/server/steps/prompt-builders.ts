...
export interface PromptBuilderContext {
  ...
  // ── Knowledge-base manager (used directly by clarify explore prompt) ──
 ...
 */
export function loadPersonaPromptSync(personaName: string): string {
...
export function warnIfSystemPromptOversized(
...
export function buildManifestPrefix(ctx: PromptBuilderContext): string {
...
export function buildRepoProjectPrompt(
  ctx: PromptBuilderContext,
  stage: StageInfo,
  repoName: string,
): string {
...
export function buildClarifyExplorePrompt(ctx: PromptBuilderContext): string {
...
export function buildRepoStagePrompt(
  ctx: PromptBuilderContext,
  stage: StageInfo,
  repoName: string,
  prevArtifact: string,
...
export function buildPerTaskPrompt(
  ctx: PromptBuilderContext,
  repoName: string,
  repoPath: string,
  task: ParsedTask,
