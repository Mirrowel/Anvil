...
export const routes: RouteConfig[] = [
  ...
  { path: '/tests', id: 'tests', label: 'Test Gen', primary: true },
  { path: '/guards', id: 'guards', label: 'Guards', primary: true },
  { path: '/contracts', id: 'contracts', label: 'Contracts', primary: true },
  { path: '/triage', id: 'triage', label: 'CI Triage', primary: true },
