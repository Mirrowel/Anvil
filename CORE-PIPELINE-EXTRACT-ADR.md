...
| 9 — Tests + docs + ADR finalize | shipped | 24f7502 | core-pipeline 40/40 (7 new integration tests); README with 6 sections; ADR status flipped to Shipped; final gates: agent-core 152/152, memory-core 119/119, knowledge-core 62/62, jest 7/7, cli build |
